...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<link rel="stylesheet" href="{{asset('plantilla/css/bootstrap.css')}}">
	<link rel="stylesheet" href="{{asset('plantilla/css/font-awesome.css')}}">
	<link rel="stylesheet" href="{{asset('plantilla/css/main.css')}}">
	<link rel="stylesheet" href="{{asset('plantilla/css/jquery.bxslider.css')}}">
	<script src="{{asset('plantilla/js/modernizr.custom.js')}}"></script>
		...
		<div class="navbar navbar-smak navbar-fixed-top " id="navbar" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand animate" href="#"><img src="{{asset('plantilla/img/logo.png')}}" alt="logo1"></a>
				</div>
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right animate">
						...
						<li><a href="#clients">Invitacion</a></li>
			...
			<div class="slide text-slider-wrapper">
				<div class="container">
					<ul class="text-slider clearfix">
						<li class="clearfix">
							<span class="lead">juego del Calamar</span>
							<a href="#register" class="btn btn-primary outline-outward">Registrate</a>
						</li>
						<li class="clearfix">
							<span class="lead">Atrebete a Jugar</span>
							<a href="#register" class="btn btn-primary outline-outward">Registrate</a>
						</li>
						<li class="clearfix">
							<span class="lead">Registrate y juega</span>
							<a href="#register" class="btn btn-primary outline-outward">Registrate</a>
						</li>
					</ul>
				</div>
        ...
        <section id="register">
			<div class="branded-section contact-form">
				<div class="masked">
					<div class="container">
						<div class="heading">
							<h1 class="light-font">Registrate y participa</h1>
							<p class="light-font">Una vez registrado nostros te llamamos con anticipacion indicando la fecha, la hora y el lugar</p>
						</div>
						<form class="form-horizontal" method="POST" action="{{route('calamar.guardar')}}">
                            @csrf
							<div class="form-group">
								<div class="col-sm-4" style="position:relative">
									<input type="text" name="nombre" data-new-placeholder="Cual es tu nombre?" value="David" class="form-control label_better" placeholder="Nombre">
								</div>
								<div class="col-sm-4">
									<input type="text" name="telefono" class="form-control label_better" value="710339910" placeholder="Teléfono">
								</div>
								<div class="col-sm-4">
									<input type="date" name="fecha" class="form-control label_better" value="2000-12-02" placeholder="Fecha nacimiento">
								</div>
							</div>
							
							<div class="form-group">
								<div class="col-sm-12">
									<textarea class="form-control label_better" name="descripcion" placeholder="Por que te gustaría Jugar" rows="5">Esto es un datos descriptivo</textarea>
								</div>
							</div>
	...
	<script type="text/javascript" src="{{asset('plantilla/js/bootstrap.js')}}"></script>
	<script type="text/javascript" src="{{asset('plantilla/js/jquery.bxslider.js')}}"></script>
	<script type="text/javascript" src="{{asset('plantilla/js/jquery.label_better.js')}}"></script>
	<script type="text/javascript" src="{{asset('plantilla/js/jquery.mixitup.js')}}"></script>
	<script type="text/javascript" src="{{asset('plantilla/js/jquery.easypiechart.js')}}"></script>
	<script type="text/javascript" src="{{asset('plantilla/js/jquery.inview.js')}}"></script>
	<script type="text/javascript" src="{{asset('plantilla/js/countUp.js')}}"></script>
	<script type="text/javascript" src="{{asset('plantilla/js/main.js')}}"></script>
	<script src="{{asset('plantilla/js/grid.js')}}"></script>
	<script>
	$(function() {
		Grid.init();
	});
